...
const julianDate1 = Cesium.JulianDate.fromIso8601(isoDate);

console.log(julianDate,'11111111',julianDate1);

// 转换为 JavaScript Date 对象
const dateObj = Cesium.JulianDate.toDate(julianDate);

// 转换为 ISO 8601 字符串
const isoString = Cesium.JulianDate.toIso8601(julianDate1);

console.log(dateObj, isoString);
